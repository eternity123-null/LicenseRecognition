...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default=r"D:\zcd\CV\rec_imgs\train", help='the train images path')
    parser.add_argument('--test_img_dirs', default=r"D:\zcd\CV\rec_imgs\test", help='the test images path')
    parser.add_argument('--dropout_rate', default=0.5, help='dropout rate.')
    parser.add_argument('--learning_rate', default=0.00001, help='base value of learning rate.')
    ...
    parser.add_argument('--pretrained_model', default=r'D:\zcd\CV\LPRNet_Pytorch\weights\LPRNet__iteration_11000.pth', help='pretrained base model')
